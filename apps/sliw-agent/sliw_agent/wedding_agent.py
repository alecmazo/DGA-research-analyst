...
def wedding_ready_list(limit: int = 12, *, channel: str | None = None) -> list[dict[str, Any]]:
    ...
    for p in ranked[:limit]:
        ...
        out.append({
            ...
            "last_contacted_at": p.get("last_contacted_at") or "",
            "last_contacted_email": p.get("last_contacted_email") or "",
...
def apply_stripe_checkout_session(session: dict[str, Any]) -> dict[str, Any]:
    ...
    pkg_label = {
        ...
        "package_10": "Wedding lesson package ×10 ($1,450)",
