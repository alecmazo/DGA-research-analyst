...
def format_verified_block(data: dict) -> str:
    ...
    lines.append(
        ...
        "Banks/thrifts: Revenue = Total Interest Income + Noninterest Income "
        "(never ASC-606 fee-only contract revenue). Net interest income is used "
        "as GrossProfit when GAAP GrossProfit is absent. "
