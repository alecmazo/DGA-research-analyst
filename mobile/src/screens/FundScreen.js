...
const s = StyleSheet.create({
  ...
  // Compact managed-account cards (desktop ui440 density)
  fundSummaryCard:    { marginHorizontal: 10, marginBottom: 6, backgroundColor: '#0e1e35', borderRadius: 8, borderWidth: 1, borderColor: 'rgba(91,184,212,0.22)', overflow: 'hidden' },
  fundSummaryHeader:  { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingTop: 8, paddingBottom: 4 },
  fundSummaryName:    { fontSize: 13, fontWeight: '700', color: '#e8f0f8', marginBottom: 1 },
  fundSummaryShort:   { fontSize: 10, color: '#4a6080' },
  fundSummaryStatusBadge: { backgroundColor: 'rgba(74,200,112,0.12)', borderRadius: 3, paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1, borderColor: 'rgba(74,200,112,0.3)' },
  fundSummaryStatusText:  { fontSize: 8, fontWeight: '800', color: '#4cc870', letterSpacing: 0.6 },
  fundSummaryMetrics: { flexDirection: 'row', borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: 'rgba(255,255,255,0.06)', paddingHorizontal: 6, paddingVertical: 6 },
  fundSummaryMetric:  { flex: 1, alignItems: 'center' },
  fundSummaryMetricLabel: { fontSize: 7, fontWeight: '700', color: '#3a5070', letterSpacing: 0.5, marginBottom: 1 },
  fundSummaryMetricValue: { fontSize: 12, fontWeight: '700', color: '#e8f0f8', fontVariant: ['tabular-nums'] },
  fundSummaryCTA:     { fontSize: 10, fontWeight: '700', color: colors.primary, textAlign: 'right', paddingHorizontal: 10, paddingBottom: 6 },
  ...
  // Fund list view
  fundListHint: { fontSize: 10, color: '#3a5070', marginBottom: 8, letterSpacing: 0.3 },
  // Compact LP fund cards (desktop ui440 density)
  fundCard: {
  ...
  fundCardHeader:    { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 6 },
  fundCardName:      { fontSize: 13, fontWeight: '800', color: '#f0e8d0', marginBottom: 1 },
  fundCardShort:     { fontSize: 10, color: '#4a6080' },
  fundStatusBadge:   { borderWidth: 1, borderRadius: 4, paddingHorizontal: 5, paddingVertical: 1, marginLeft: 6, marginTop: 1 },
  fundStatusText:    { fontSize: 8, fontWeight: '800', letterSpacing: 0.4 },
  fundCardMetrics:   { flexDirection: 'row', gap: 4, marginBottom: 6 },
  fundCardMetric:    { flex: 1, backgroundColor: '#081526', borderRadius: 6, paddingVertical: 5, paddingHorizontal: 4, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  fundCardMetricLabel:{ fontSize: 7, fontWeight: '700', color: '#3a5070', letterSpacing: 0.4, marginBottom: 1 },
  fundCardMetricValue:{ fontSize: 12, fontWeight: '800', color: '#f0e8d0', fontVariant: ['tabular-nums'] },
  fundCardCta:       { alignSelf: 'flex-end' },
  fundCardCtaText:   { fontSize: 10, fontWeight: '700', color: colors.primary },
