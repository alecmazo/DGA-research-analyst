...
Usage:
    ...
    python3 DGA_analyst.py --portfolio /path/to/portfolio.csv
    python3 DGA_analyst.py --portfolio /path/to/portfolio.xlsx --no-gamma
    python3 DGA_analyst.py --portfolio portfolio_watchlist.xlsx --strategy pro
    python3 DGA_analyst.py --portfolio portfolio_watchlist.xlsx --strategy concentrated --reuse
